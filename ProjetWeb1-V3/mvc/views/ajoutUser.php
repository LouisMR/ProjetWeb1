        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="ajoutUserSubmit.php" method="post">
                    <input type="text" class="nomUtilisateur" id="ajoutUser" placeholder="Entrez le nom d'utilisateur"><br><br>
                    <input type="text" class="courriel" id="ajoutCourriel" name="courriel" placeholder="Entrez le courriel"><br><br>
                    <input type="password" class="password" id="ajoutPassword" placeholder="Entrez le mot de passe">
                </form>
                </div>
                <div class="modal-footer">
                    <input type="button" class="btn btn-dark" value="Valider">
                </div>
            </div>
        </div>
    </div>
